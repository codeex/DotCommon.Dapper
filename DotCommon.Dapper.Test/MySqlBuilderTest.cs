...
namespace DotCommon.Dapper.Test
{
    public class MySqlBuilderTest
    {
        ...
        private readonly IConciseSqlBuilder _sqlBuilder = new MySqlConciseBuilder();
        ...
        public void BuildQueryPaged_Test()
        {
            ...
            string expectSql = "SELECT * FROM Table1  WHERE `Id` = @Id AND `Name` = @Name ORDER BY Id LIMIT 5,5";
            Assert.Equal(expectSql.Trim(), sql.Trim());
        }
    }
}
